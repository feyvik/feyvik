    ...
    <FooterWrapper ref={contactRef} className="bg-dark">
      <div className="container">
        <div className="footer_content">
          ...
          <div className="text-left mb-6">
            ...
            <div className="mt-4">
              <p className="text-white mb-4">
                I'm always open to connecting, collaborating, or just chatting
                <br className="hidden sm:block" />
                about frontend development, community building, or breaking into
                tech.
              </p>
              <ul>
                <li className="mb-2">
                ...
                <li className="mb-2">
                  💻 GitHub:
                  <a
                    href="https://github.com/feyvik"
                    target="_blank"
                    className="ms-1">
                    https://github.com/feyvik
                  </a>
                </li>
                <li className="mb-2">
                  Community: Learn with me at
                  <a
                    href="https://www.thefletribe.com.ng"
                    target="_blank"
                    className="ms-1">
                    The FLE Tribe
                  </a>
          ...
          <div className="flex flex-wrap items-center border-t pt-6 border-[#ffffff58]">
            <div className="w-[100%] sm:w-[50%] mb-4 sm:mb-0">
              <div className="social-media">
                <a href="https://www.facebook.com/feyvik/" target="_blank">
                  <svg
                ...
                <a href="https://www.x.com/feyvik" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a href="https://www.instagram.com/fey_vik" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a href="https://www.linkedin.com/in/feyvik/" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a href="https://www.youtube.com/@feyvik" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a href="https://www.tiktok.com/@feyvik" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
            ...
            <div className="w-[100%] sm:w-[50%] sm:text-end text-white">
              <p>&copy; Copyright Favour Vivian Woka 2025</p>
            </div>
          </div>
        </div>
      </div>
